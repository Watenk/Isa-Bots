...
public class MainIDRenderer : BaseClass
{
    ...
    private void GenerateQuads()
    {
        ...
        for (int y = 0; y < Grid.Height; y++)
        {
            ...
            {
                int currentTileID = (int)Grid.GetTile(new Vector2Int(x, y)).MainID;

                if (currentTileID != (int)MainID.none)
                {
                    //Generate quads
                    //Vertices
                ...
                else
                {
                    ...
                    //Map values to uv
                    uv[verticesAndUvIndex + 1] = new Vector2(uv00[0].x, uv00[0].y);
                    uv[verticesAndUvIndex + 2] = new Vector2(uv11[0].x, uv00[0].y);
                    uv[verticesAndUvIndex + 0] = new Vector2(uv00[0].x, uv11[0].y);
                    uv[verticesAndUvIndex + 3] = new Vector2(uv11[0].x, uv11[0].y);
                }
                i++;
            }
        }
